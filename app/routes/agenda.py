...
def agenda_unificata():
    ...
    eccezioni = AgendaService.get_eccezioni(future_only=True, utente_id=uid)
    orari_settimanali = AgendaService.get_orari_settimanali(utente_id=uid)
    ...
    for i in range(42):
        ...
        chiuso = AgendaService.is_giorno_chiuso(giorno_data, eccezioni, utente_id=uid)
